                ...
                <div className="row align-items-center">
                    <div className="col-lg-6">
                        <div className="about_video mt-50">
                            <div
                                className="scripps_iframe_embed"
                    ...
                    <div className="col-lg-6">
                        <div className="about_content_2 mt-45">
                            <h4 className="about_title">
                                We've kept 68 kids out of jails since 2009
                            </h4>
                            <p>
                                Headquartered in Omaha, Nebraska, the Mays Foundation has built a
                                recognizable reputation for providing youth with the opportunity
                                to learn and grow in a safe, supportive environment, free from the
                                bondage of the streets.
                            </p>
                            <div className="row">
                                <div className="col-md-6">
                                    <div className="single_about_items_2 d-flex">
                                        ...
                                        <div className="items_content media-body">
                                            ...
                                            <p>
                                                Local businesses continually show our youth the support
                                ...
                                <div className="col-md-6">
                                    <div className="single_about_items_2 d-flex">
                                        ...
                                        <div className="items_content media-body">
                                            ...
                                            <p>
                                                Each year, our program enrolls ~20 gang-affiliated youths
                                                for mentorship and growth
                                            </p>
                                        </div>
                                    </div>{" "}
                                    {/* single about items */}
